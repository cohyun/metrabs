...
*   V3.7 10-Jan-18, M Liu       Added ARM and IA64 encoding.
*
******************************************************************************/
...
#endif
#if defined(ARM_LITTLE)
  return ((Int32) ARM_LITTLE_ENCODING);
#endif
#if defined(ARM_BIG)
  return ((Int32) ARM_BIG_ENCODING);
#endif
#if defined(ia64vmsI)
  return ((Int32) IA64VMSi_ENCODING);
#endif
#if defined(ia64vmsD)
  return ((Int32) IA64VMSd_ENCODING);
#endif
#if defined(ia64vmsG)
  return ((Int32) IA64VMSg_ENCODING);
#endif
}
...
#endif
#if defined(ARM_LITTLE)
  return ((Int32) ARM_LITTLE_DECODING);
#endif
#if defined(ARM_BIG)
  return ((Int32) ARM_BIG_DECODING);
#endif
#if defined(ia64vmsI)
  return ((Int32) IA64VMSi_DECODING);
#endif
#if defined(ia64vmsD)
  return ((Int32) IA64VMSd_DECODING);
#endif
#if defined(ia64vmsG)
  return ((Int32) IA64VMSg_DECODING);
#endif
}
...
Int32 ed;                /* Encoding/decoding. */
{
  switch (ed) {
    ...
    case IBMPC_ENCODING:
    case VAX_ENCODING:
    case ARM_LITTLE_ENCODING:
    case IA64VMSi_ENCODING:
    case IA64VMSd_ENCODING:
    case IA64VMSg_ENCODING:
